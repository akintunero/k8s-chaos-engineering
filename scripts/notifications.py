...
class NotificationService:
    ...
    def notify_experiment_completed(
        self, experiment_name: str, namespace: str, success: bool = True, details: Optional[Dict[str, Any]] = None
    ) -> bool:
...
def main():
    ...
    parser.add_argument("--level", choices=["info", "warning", "error", "success"], default="info", help="Notification level")
